...
public class windowClean03 : MonoBehaviour {
    int r = 10;
    bool tf = false;
    ...
    void Update()
    {
        ...
        Vector2 imin = Camera.main.WorldToScreenPoint(gameObject.GetComponent<SpriteRenderer>().bounds.min);
        Vector2 imax = Camera.main.WorldToScreenPoint(gameObject.GetComponent<SpriteRenderer>().bounds.max);
